...
<head>
    ...
    <title>icb 2017</title>

    <!-- css -->
    <link rel="stylesheet" href="/icb/Application/Home/View//Public/static/css/bootstrap.min.css">
    <link rel="stylesheet" href="/icb/Application/Home/View//Public/static/css/ionicons.min.css">
    <link rel="stylesheet" href="/icb/Application/Home/View//Public/static/css/conference.css">
</head>
<body data-spy="scroll" data-target="#site-nav">
            ...
            <div class="navbar-header">
                ...
                <div class="site-branding">
                    <a class="logo" href="index.html">
                        ...
                        <!-- logo image  -->
                        <img src="/icb/Application/Home/View//Public/static/img/logo.png" alt="Logo">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <figure>
                        <img alt="" class="img-responsive" src="/icb/Application/Home/View//Public/static/img/about-us.jpg">
                    </figure>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="/icb/Application/Home/View//Public/static/img/speakers/speaker-1.jpg">
                        </figure>
                ...
                <div class="col-md-4">
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="/icb/Application/Home/View//Public/static/img/speakers/speaker-2.jpg">
                        </figure>
                ...
                <div class="col-md-4">
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="/icb/Application/Home/View//Public/static/img/speakers/speaker-3.jpg">
                        </figure>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="/icb/Application/Home/View//Public/static/img/speakers/speaker-4.jpg">
                        </figure>
                ...
                <div class="col-md-4">
                    ...
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="/icb/Application/Home/View//Public/static/img/speakers/speaker-5.jpg">
                        </figure>
                ...
                <div class="col-md-4">
                    <div class="speaker">
                        <figure>
                            <img alt="" class="img-responsive center-block" src="/icb/Application/Home/View//Public/static/img/speakers/speaker-6.jpg">
                        </figure>
                        <h4>Jhon Smith</h4>
                        <p>CEO of Peren</p>
                        <ul class="social-block">
                ...
                <div class="col-md-12">
                    <ul class="grid">
                        ...
                        <li class="grid-item grid-item-sm-6">
                            <img alt="" class="img-responsive center-block" src="/icb/Application/Home/View//Public/static/img/photos/photos-1.jpg">
                        </li>

                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="/icb/Application/Home/View//Public/static/img/photos/photos-2.jpg">
                        </li>

                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="/icb/Application/Home/View//Public/static/img/photos/photos-3.jpg">
                        </li>
                    
                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="/icb/Application/Home/View//Public/static/img/photos/photos-5.jpg">
                        </li>

                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="/icb/Application/Home/View//Public/static/img/photos/photos-6.jpg">
                        </li>

                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="/icb/Application/Home/View//Public/static/img/photos/photos-7.jpg">
                        </li>

                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="/icb/Application/Home/View//Public/static/img/photos/photos-8.jpg">
                        </li>
    ...
    <!-- script -->
    <script src="/icb/Application/Home/View//Public/static/js/jquery.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="/icb/Application/Home/View//Public/static/js/bootstrap.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="/icb/Application/Home/View//Public/static/js/smooth-scroll.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="/icb/Application/Home/View//Public/static/js/conference.js" type="text/javascript" charset="utf-8"></script>
</body>
</html>