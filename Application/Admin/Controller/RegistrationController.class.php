...
//			case 'register_abstract':break;
	...
	public function details_reg(){
		...
		$curr_time = time();
		$early_time = strtotime (date("2016-11-15")); //Early Bird 截止期日
		$refer_type_list = C('REFER_TYPE_LIST');
	...
	public function letter_reg(){
		...
		->field('reg.*,visa.full_name,visa.address,visa.zip,visa.city,visa.country,visa.birth_date,count(DISTINCT abs.abstract_id) abs_num')
		->group('reg.reg_id')
